...
public class Parser
{
  ...
  public Parser(){
    ...
    con=DriverManager.getConnection(  
       "jdbc:mysql://ipparser.c3fxdgnnonos.us-east-2.rds.amazonaws.com","administrator","abcdefgh");
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    while(sc.hasNextLine())
    {
        ...
        if(ipCounts.containsKey(ip)) ipCounts.put(ip, ipCounts.get(ip)+1);
        else ipCounts.put(ip, 1);
